...
list = ['#toronto','#retail', '#covid', '#pfizer', '#moderna']
...
# Filter the hashtags to be the 5 i have in list
filtered = hashtags.filter(lambda tag: tag.lower() in list)

# map each hashtag to be a pair of (hashtag,1)
hashtag_counts = filtered.map(lambda x: (x.lower(), 1))
